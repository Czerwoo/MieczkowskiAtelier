  ...
  return (
    <>
      <h3 className="text-4xl font-bold mb-4">
        Peruki i toppery z włosów naturalnych piękno stworzone dla Ciebie!
      </h3>
      <div
        id="aboutUs"
      ...
      >
        <div className="w-full max-w-screen-xl flex flex-col md:flex-row">
          ...
          <div className="flex flex-col py-6 sm:py-10 md:py-20 justify-around md:w-1/2">
            <h2 className="text-xs sm:text-sm md:text-base"></h2>
            <p className="text-xs sm:text-sm md:text-base m-8">
              Marzysz o fryzurze, która będzie wyglądać i układać się jak Twoje
        ...
        <div className="w-full max-w-screen-xl flex flex-col md:flex-row">
          ...
          <div className="flex flex-col py-6 sm:py-10 md:py-20 justify-around md:w-1/2">
            <p className="text-xs sm:text-sm md:text-base">
              - 100% naturalne włosy - Indywidualny dobór koloru i długości -
              Naturalny wygląd i komfort noszenia Ręczne wykonanie To więcej niż
              peruka to Twoja nowa fryzura, która podkreśli Twoją osobowość.
